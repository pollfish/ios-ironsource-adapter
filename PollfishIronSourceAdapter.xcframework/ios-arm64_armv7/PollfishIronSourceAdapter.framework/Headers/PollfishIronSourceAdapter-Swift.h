...
#ifndef POLLFISHIRONSOURCEADAPTER_SWIFT_H
#define POLLFISHIRONSOURCEADAPTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PollfishIronSourceAdapter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("ISPollfishCustomAdapter")
@interface ISPollfishCustomAdapter : ISBaseNetworkAdapter
...
SWIFT_CLASS_NAMED("ISPollfishCustomRewardedVideo")
@interface ISPollfishCustomRewardedVideo : ISBaseRewardedVideo <PollfishDelegate>
